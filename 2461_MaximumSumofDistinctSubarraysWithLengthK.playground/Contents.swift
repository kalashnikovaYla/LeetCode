/*
 ...
 k - необходимая длинна подмассива
 
 заведем 2 переменные maxSum и sum
 и по сути 2 указателя left right
 right - двигается вперед
 left - стоит сначала на 1 элементе чтобы в случае чего отнимать
 
 
 когда элементов стало больше чем надо отнимаем из начала
